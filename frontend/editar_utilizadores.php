                    ...
                    <form id="addUserForm" action='../backend/gestao_utilizadores/inserir.php' method='post'>
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_tipos_utilizador" id="id_tipos_utilizador" class="form-select" required>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php while ($registo = mysqli_fetch_array($resultado)): ?>
                                    <?php if ($registo["nick"] == "admin" && $_SESSION["nick"] != "admin") continue; ?>
                                    <tr>
                                        <form id='form<?php echo $registo["id"]; ?>' action='' method='post' onsubmit='return confirmAction(event)'>
